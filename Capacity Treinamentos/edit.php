    ...
    if(!empty($_GET['id']))
    {
        ...
        if($result->num_rows > 0)
        {
            while($user_data = mysqli_fetch_assoc($result))
            {
                ...
                $carga_horaria = $user_data['carga_horaria'];
                $endereco = $user_data['endereco'];
                $data = $user_data['data_curso'];
                $instrutor = $user_data['instrutor'];
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link" href="formulario.php">Agendar</a>
                ...
                <form class="form" action="saveEdit.php" method="POST">
                    <div class="curso">
                        <div class="div-instrutor">
                            ...
                            <input class="input-empresa" type="text" name="empresa" value=<?php echo $empresa;?> required>
                        </div>
                        <div class="div-curso">
                            <label for="curso">Carga horária</label>
                            <input class="input-carga" type="text" name="carga_horaria" value=<?php echo $carga_horaria;?> required>
                        </div>
                    </div>
    ...
    <select name="instrutor">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $selected = ($email_instrutor == $instrutor) ? 'selected' : ''; // Verifica se esta é a opção selecionada
            ?>
            <option value="<?php echo $email_instrutor; ?>" <?php echo $selected; ?>><?php echo $email_instrutor; ?></option>
        <?php
        }
        ?>
    </select>
                        ...
                        <div class="input-date">
                            ...
                            <input type="date" name="data_curso" value=<?php echo $data;?> required>
                        </div>
                    </div>
                    ...
                    <div class="radio">
                        ...
                        <div class="nr">
                            <input type="radio" id="nr10" name="curso" value="NR-10" <?php echo ($curso == 'NR-10') ? 'checked' : '';?> required>
                            <label for="nr10">NR-10</label>
                        </div>
                        <div class="nr">
                            <input type="radio" id="nr35" name="curso" value="NR-35" <?php echo ($curso == 'NR-35') ? 'checked' : '';?> required>
                            <label for="nr35">NR-35</label>
                        </div>
                        <div class="nr">
                            <input type="radio" id="nr" name="curso" value="Brigada" <?php echo ($curso == 'Brigada') ? 'checked' : '';?>required>
